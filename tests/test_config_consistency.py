...
class TestConfigConsistency:
    ...
    def test_critical_parameters_documentation(self):
        ...
        assert "yaw_authority: 0.10" in content, "yaw_authority not set to 0.10"
    ...
    def test_parameter_ranges_are_reasonable(self):
        ...
        assert py_cfg.crash_penalty >= 10.0, "crash_penalty too low - won't discourage crashes"

        # alive_bonus should be positive but not dominate
        assert 0.0 < py_cfg.alive_bonus < 1.0, "alive_bonus out of reasonable range"
        ...
        assert py_cfg.yaw_authority <= 1.0, "yaw_authority too high - may cause instability"
