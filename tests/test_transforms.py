...
class TestGPSTransforms:
    ...
    def test_geodetic_to_ned_roundtrip(self):
        ...
        lat, lon, alt = GPSTransforms.ned_to_geodetic(original_ned, ref_lat, ref_lon, ref_alt)

        recovered_ned = GPSTransforms.geodetic_to_ned(lat, lon, alt, ref_lat, ref_lon, ref_alt)
