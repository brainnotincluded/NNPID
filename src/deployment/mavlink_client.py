...
from ..communication.messages import SetpointCommand, PX4Mode
...
class MAVLinkClient:
    ...
    def __init__(self, config: Optional[ClientConfig] = None):
        ...
        # Callbacks
        self._on_state_update: Optional[Callable[[DroneState], None]] = None
    ...
    def send_velocity_setpoint(
        ...
        type_mask = (
            0b0000_0001_1111_1000  # Ignore position, acceleration, yaw
        )
    ...
    def send_position_setpoint(
        ...
        if dist_from_home > self.config.geofence_radius:
            print(f"Position outside geofence")
            return False
        
        # Type mask for position control
        type_mask = (
            0b0000_1111_1111_1000  # Ignore velocity, acceleration, yaw rate
        )
