...
class SetpointHoverEnv(SetpointBaseEnv):
    ...
    def __init__(
        self,
        config: Optional[SetpointHoverConfig] = None,
...
class SetpointWaypointEnv(SetpointBaseEnv):
    ...
    def __init__(
        self,
        config: Optional[SetpointWaypointConfig] = None,
        render_mode: Optional[str] = None,
    ):
...
class SetpointTrackingEnv(SetpointBaseEnv):
    ...
    def __init__(
        self,
        config: Optional[SetpointTrackingConfig] = None,
        render_mode: Optional[str] = None,
    ):
    ...
    def _get_info(self) -> Dict[str, Any]:
        ...
        info["mean_tracking_error"] = (
            self._total_tracking_error / max(1, self._step_count)
        )
        return info
