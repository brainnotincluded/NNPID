...
class MAVLinkBridge:
    ...
    def __init__(self, config: MAVLinkConfig | None = None):
        ...
        self._last_actuators: HILActuatorControls | None = None

        # Callbacks
        self._on_actuators: Callable[[HILActuatorControls], None] | None = None
    ...
    def get_actuators(self, timeout: float = 0.1) -> HILActuatorControls | None:
    ...
    def get_motor_commands(self, timeout: float = 0.1) -> np.ndarray | None:
    ...
    @property
    def last_actuators(self) -> HILActuatorControls | None:
...
class SimpleTCPBridge:
    ...
    def receive_motors(self) -> np.ndarray | None:
