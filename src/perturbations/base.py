...
class BasePerturbation(ABC):
    ...
    def _randomize_parameters(self) -> None:  # noqa: B027
...
class PerturbationManager:
    ...
    def remove_perturbation(self, name: str) -> BasePerturbation | None:
    ...
    def get_perturbation(self, name: str) -> BasePerturbation | None:
    ...
    def get_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "perturbations": {name: p.get_info() for name, p in self._perturbations.items()},
        }
    ...
    @classmethod
    def from_config(cls, config: dict[str, Any], seed: int | None = None) -> PerturbationManager:
